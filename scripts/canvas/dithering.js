...
class DitheringEngine {
     ...
     */
    applyFloydSteinberg(lightColor = '#FFFFFF', darkColor = '#000000', threshold = 127) {
     ...
     */
    applyOrderedDithering(lightColor = '#FFFFFF', darkColor = '#000000', matrixSize = 4) {
        // Get the canvas image data
        const ctx = this.canvas.ctx;
        const width = this.canvas.width;
        const height = this.canvas.height;
        ...
        for (let y = 0; y < height; y++) {
            for (let x = 0; x < width; x++) {
                ...
                const threshold = (matrix[matrixY][matrixX] + 1) / (matrixLength * matrixLength + 1) * 255;
     ...
     */
    applyNoiseDithering(lightColor = '#FFFFFF', darkColor = '#000000', threshold = 127, noiseAmount = 0.5) {
        // Get the canvas image data
        const ctx = this.canvas.ctx;
        const width = this.canvas.width;
        const height = this.canvas.height;
