...
class Timeline {
  ...
  setupEventListeners () {
    ...
    document
      ...
      .addEventListener('click', () => this.createNewFrame())
    document
      .getElementById('duplicate-frame')
      .addEventListener('click', () => this.duplicateCurrentFrame())
    document
      .getElementById('delete-frame')
      .addEventListener('click', () => this.deleteCurrentFrame())
    ...
    document
      .getElementById('loop-animation')
      .addEventListener('click', () => this.toggleLoopAnimation())
  ...
  selectFrame (index) {
    ...
    if (this.frames.length > 0 && this.currentFrameIndex < this.frames.length) {
      this.frames[this.currentFrameIndex].setImageData(
  ...
  applyOnionSkin () {
    ...
    if (prevIndex >= 0) {
      ...
      this.pixelCanvas.effectsCtx.globalAlpha =
        this.options.onionSkinOpacity / 2
  ...
  startAnimationLoop () {
    ...
    const showNextFrame = () => {
      ...
      // Clear the canvas
      this.pixelCanvas.effectsCtx.clearRect(
        0,
        0,
      ...
      // Draw the frame
      this.pixelCanvas.setCanvasFromImageData(
  ...
  createEmptyImageData () {
    ...
    return new ImageData(this.pixelCanvas.width, this.pixelCanvas.height)
  }
