...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function setupEventListeners() {
    ...
    document.getElementById('file-menu-button').addEventListener('click', (e) => {
      ...
      if (menu.style.display === 'flex') {
        ...
        document.getElementById('file-menu-button').classList.remove('active');
      } else {
        ...
        document.getElementById('file-menu-button').classList.add('active');
      }
    });

    document.getElementById('edit-menu-button').addEventListener('click', (e) => {
      e.stopPropagation();
      const menu = document.getElementById('edit-menu');
      if (menu.style.display === 'flex') {
        menu.style.display = 'none';
        document.getElementById('edit-menu-button').classList.remove('active');
      } else {
        // Close all menus first
        document.querySelectorAll('.menu-dropdown').forEach(m => {
          m.style.display = 'none';
        ...
        menu.style.zIndex = '2000';
        menu.style.display = 'flex';
        document.getElementById('edit-menu-button').classList.add('active');
      }
    });

    document.getElementById('view-menu-button').addEventListener('click', (e) => {
      e.stopPropagation();
      const menu = document.getElementById('view-menu');
      if (menu.style.display === 'flex') {
        menu.style.display = 'none';
        document.getElementById('view-menu-button').classList.remove('active');
      } else {
        // Close all menus first
        document.querySelectorAll('.menu-dropdown').forEach(m => {
          m.style.display = 'none';
        ...
        menu.style.zIndex = '2000';
        menu.style.display = 'flex';
        document.getElementById('view-menu-button').classList.add('active');
      }
    });

    document.getElementById('export-menu-button').addEventListener('click', (e) => {
      e.stopPropagation();
      const menu = document.getElementById('export-menu');
      if (menu.style.display === 'flex') {
        menu.style.display = 'none';
        document.getElementById('export-menu-button').classList.remove('active');
      } else {
        // Close all menus first
        document.querySelectorAll('.menu-dropdown').forEach(m => {
          m.style.display = 'none';
        ...
        menu.style.zIndex = '2000';
        menu.style.display = 'flex';
        document.getElementById('export-menu-button').classList.add('active');
      }
    });

    document.getElementById('lore-menu-button').addEventListener('click', (e) => {
      e.stopPropagation();
      const menu = document.getElementById('lore-menu');
      if (menu.style.display === 'flex') {
        menu.style.display = 'none';
        document.getElementById('lore-menu-button').classList.remove('active');
      } else {
        // Close all menus first
        document.querySelectorAll('.menu-dropdown').forEach(m => {
          m.style.display = 'none';
        ...
        menu.style.zIndex = '2000';
        menu.style.display = 'flex';
        document.getElementById('lore-menu-button').classList.add('active');
      }
    });
    ...
    // Menu item event listeners for each menu item
    document.querySelectorAll('.menu-item').forEach(item => {
      item.addEventListener('click', (e) => {
        e.stopPropagation();
        // Close all menus when a menu item is clicked
        document.querySelectorAll('.menu-dropdown').forEach(m => {
          m.style.display = 'none';
        });
        document.querySelectorAll('.menu-button').forEach(b => {
  ...
  function showCanvasSizeSelectionDialog() {
    ...
    const canvasSizes = [
      ...
      { width: 350, height: 350, name: '350×350', description: 'Medium square' },
      { width: 800, height: 500, name: '800×500', description: 'Large landscape' },
    ...
    canvasSizes.forEach(size => {
      // We don't need preview width/height anymore since we're using fixed size preview boxes
