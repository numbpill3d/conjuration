...
class GlitchTool {
  ...
  applyRowShift() {
    ...
    for (let i = 0; i < numRows; i++) {
      ...
      const shiftAmount = Math.floor((Math.random() - 0.5) * width * this.intensity * 2);
  ...
  applyColumnShift() {
    ...
    for (let i = 0; i < numColumns; i++) {
      ...
      const shiftAmount = Math.floor((Math.random() - 0.5) * height * this.intensity * 2);
  ...
  applyDataCorruption() {
    ...
    for (let i = 0; i < numPixels; i++) {
      ...
      // Convert back to hex
      newPixelData[index] = `#${newR.toString(16).padStart(2, '0')}${newG.toString(16).padStart(2, '0')}${newB.toString(16).padStart(2, '0')}`;
    }
    ...
    for (let i = 0; i < numBlocks; i++) {
      ...
      for (let y = 0; y < blockHeight; y++) {
        for (let x = 0; x < blockWidth; x++) {
          ...
          if (srcIndex >= 0 && srcIndex < pixelData.length && destIndex >= 0 && destIndex < newPixelData.length) {
            newPixelData[destIndex] = pixelData[srcIndex];
          }
        }
      }
  ...
  applyNoiseGlitch() {
    ...
    for (let i = 0; i < numPixels; i++) {
      ...
      // Convert to hex
      newPixelData[index] = `#${r.toString(16).padStart(2, '0')}${g.toString(16).padStart(2, '0')}${b.toString(16).padStart(2, '0')}`;
    }
