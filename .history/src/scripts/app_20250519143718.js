...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function showCanvasSizeSelectionDialog() {
    ...
    canvasSizes.forEach(size => {
      ...
      sizesHTML += `
        <div class="canvas-size-option" data-width="${size.width}" data-height="${size.height}">
          <div class="canvas-size-preview" style="width: ${previewWidth}px; height: ${previewHeight}px;">
            <div class="canvas-size-silhouette"></div>
          </div>
    ...
    // Show the modal with size options
    uiManager.showModal('Select Canvas Size', sizesHTML, null, false);
