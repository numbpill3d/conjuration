...
class PixelCanvas {
  ...
  render() {
    ...
    // Use a more efficient rendering approach for larger canvases
    if (this.pixelSize * this.zoom === 1) {
      // For 1:1 pixel rendering, use ImageData for better performance
      ...
      // For scaled rendering, use the existing approach
  ...
  cleanup() {
    ...
    this.canvas.removeEventListener('mousemove', this.updateCursorPosition);
